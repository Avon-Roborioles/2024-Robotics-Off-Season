...
public class Pass15 extends CommandBase {
    private final PassSubsystem15 m_15passSubsystem;

    public Pass15(PassSubsystem15 passSubsystem15){
        m_15passSubsystem = passSubsystem15;
        addRequirements(m_15passSubsystem);
    }


    public void executepass15(){
        m_15passSubsystem.Pass15();
    }


    public void endpass15(boolean interrupted){
        m_15passSubsystem.stoppass();
    }
}
